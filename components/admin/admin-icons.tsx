...
export function IconPackage({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M21 8V5a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 5v14a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 19v-3" />
...
export function IconFolderDown({ className }: { className?: string }) {
  return (
    <svg
      className={cn('size-5', className)}
      viewBox="0 0 24 24"
      ...
      aria-hidden
    >
      <path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.89l-.812-1.22A2 2 0 0 0 9.07 2H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2Z" />
      <path d="M12 11v6" />
